//Animation timer is more or less a stopwatch
//It has two extra functionalities - an animation timer
//can run for a certain length of time and an animation timer
//takes an easing function which can control the flow of time
//i.e. fast forward or slow motion
...
AnimationTimer.prototype = {
	...
	getElapsedTime: function(now)
	{
		...
		//Otherwise we change the flow of time
		return elapsedTime * (this.easingFunction(percentComplete)/
			percentComplete);
	},
	isRunning: function()
	{
...
AnimationTimer.makeEaseOutInEasingFunction = function(strength)
{
	return function(percentComplete)
	{
...
AnimationTimer.makeEaseLinearEasingFunction = function()
{
	return function(percentComplete)
	{
